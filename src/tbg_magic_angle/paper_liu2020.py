...
relaxation_broadens_isolates_flat_bands = claim(
...
heterostrain_flat_band_fine_splitting = claim(
...
relaxation_reproduces_sts_flat_band_trends = claim(
...
derive_relaxation_reproduces_sts_flat_band_trends = deduction(
    [relaxation_broadens_isolates_flat_bands, heterostrain_flat_band_fine_splitting],
